...
export const slashCommands = [
  ...
  new SlashCommandBuilder()
    .setName('recursive')
    .setDescription('Continuously grab and implement open GitHub issues until /stoprecursive or the kill button is used')
    .addStringOption((option) =>
      option
        .setName('labels')
        .setDescription('Comma-separated labels to filter issues by (optional)')
  ...
  new SlashCommandBuilder()
    .setName('stoprecursive')
    .setDescription('Stop the recursive issue-implementation loop for this channel'),
